      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-400">
            Browse thousands of movies and TV shows or search
        ...
        <div className="mx-auto mb-10 max-w-2xl">
          <div className="flex items-center rounded-xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg backdrop-blur-sm focus-within:border-orange-500/50">
            <svg
            ...
            <div className="flex min-h-60 flex-col items-center justify-center text-center">
              ...
              {searchText && (
                <button
                  type="button"
                  onClick={() => setSearchText("")}
                  className="mt-5 rounded-lg border border-white/10 px-5 py-2.5 text-sm font-medium text-gray-300 transition hover:bg-white/5"
                >
                  Show All Movies
                </button>
              )}
